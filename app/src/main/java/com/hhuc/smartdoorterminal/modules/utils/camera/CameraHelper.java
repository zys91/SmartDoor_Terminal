package com.hhuc.smartdoorterminal.modules.utils.camera;
...
import com.hhuc.smartdoorterminal.MainApplication;
    ...
    public void start() {
        synchronized (this) {
            ...
            try {
                ...
                if (MainApplication.size_flag == 0) {
                    parameters.setPreviewSize(800, 600);
                    MainApplication.size_flag = 1;
                } else {
                    parameters.setPreviewSize(640, 480);
                    MainApplication.size_flag = 0;
                }
